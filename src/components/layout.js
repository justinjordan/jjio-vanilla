...
class Layout extends HTMLElement {
  connectedCallback() {
    ...
    <footer class="bg-blue-400 mt-10">
      <div>
        <div class="container mx-auto max-w-7xl grid grid-cols-2 gap-6 pt-8 pb-8">
      ...
      <div class="bg-blue-500">
        <div class="container mx-auto max-w-7xl grid grid-cols-2 gap-6 pt-4 pb-4">
          <div class="prose">
     ...
     <div class="container mx-auto max-w-7xl"></div>
    </footer>`;
  }
}
